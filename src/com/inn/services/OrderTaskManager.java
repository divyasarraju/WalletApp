...
public class OrderTaskManager extends AsyncTask<String, String, String> {
	...
	public OrderTaskManager(String dialog_message, JSONResponseImpl jsonResponseImpl,Context context) {
		this.dialog = new ProgressDialog(context);
	    this.dialog_message = dialog_message;
	    this.jsonResponseImpl = jsonResponseImpl;
	}

	public OrderTaskManager( JSONResponseImpl jsonResponseImpl,Context context) {
//		this.dialog = new ProgressDialog(context);
	    this.jsonResponseImpl = jsonResponseImpl;
	}
	@Override
...
//		dialog.show();
	...
	protected String doInBackground(String... uri) {
		...
		try {
			Log.d("DLOG", "OrderAsyncTaskManager.uri =  " + uri[0]);
...
//		if (dialog.isShowing())
		if(result!=null)
		jsonResponseImpl.httpResultforOrder(result);
